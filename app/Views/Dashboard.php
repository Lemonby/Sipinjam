...
<body class="bg-blue-50">
    ...
    <div class="flex h-screen">
        ...
        <aside class="w-60 bg-white shadow-lg flex flex-col">
            <!-- Logo -->
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center gap-2">
                    <div class="w-10 h-10 bg-blue-500 text-white rounded-lg flex items-center justify-center font-bold text-lg">
                        S
                    </div>
                    <div>
                        <h2 class="text-lg font-bold text-slate-800">Sipinjam</h2>
                    </div>
                </div>
            </div>
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="#" class="flex items-center gap-3 px-4 py-3 bg-blue-100 text-blue-600 rounded-lg font-medium transition">
            ...
            <div class="p-4 border-t border-gray-200">
                <a href="<?= site_url('/logout') ?>" class="flex items-center justify-center gap-2 w-full bg-red-500 hover:bg-red-600 text-white font-semibold px-4 py-3 rounded-lg transition">
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-md mb-8">
                            <div class="flex justify-between items-center mb-6">
                                <h2 class="text-xl font-bold text-slate-800">Peminjamanku</h2>
                            ...
                            <div class="flex gap-4 pb-4 border-b border-gray-200 mb-4">
                                ...
                                <div class="flex-1">
                                    <h3 class="font-semibold text-slate-800">Atomic Habit</h3>
                            ...
                            <div class="flex gap-4 pb-4 border-b border-gray-200 mb-4">
                                ...
                                <div class="flex-1">
                                    <h3 class="font-semibold text-slate-800">Psychology Of Money</h3>
                                    <p class="text-sm text-gray-600">James Clare</p>
                                    <div class="flex items-center gap-2 mt-2 text-orange-500">
                                        <i class="bi bi-hourglass-split text-sm"></i>
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-md">
                            <div class="flex justify-between items-center mb-6">
                                <h2 class="text-xl font-bold text-slate-800">Rekomendasi Untukmu</h2>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-xs font-medium text-green-600 bg-green-100 rounded px-2 py-1 inline-block mb-1">Tersedia</p>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-md">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="p-3 border-l-4 border-blue-500 bg-blue-50 rounded">
                                    <p class="text-xs font-semibold text-slate-800">Reservasi Buku "Clean Code" sudah tersedia</p>
                                    <p class="text-xs text-gray-600 mt-1">10 menit yang lalu</p>
                                </div>

                                <!-- Notification 2 -->
                                <div class="p-3 border-l-4 border-gray-300 bg-gray-50 rounded">
                                    <p class="text-xs font-semibold text-slate-800">Masa pinjam "The Pragmatic Programmer" akan habis dalam 3 hari</p>
                        ...
                        <!-- JAM OPERASIONAL -->
                        <div class="bg-white rounded-2xl p-6 shadow-md">
                            <h3 class="font-bold text-slate-800 mb-4">Jam Operasional</h3>
