...
<aside class="w-64 bg-white shadow-md flex flex-col h-screen overflow-y-auto">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        <a href="<?= site_url('/dashboard') ?>" class="flex items-center gap-3 px-4 py-3 bg-blue-100 text-blue-600 rounded-lg font-medium hover:bg-blue-200 transition duration-200">
            <i class="bi bi-speedometer2 flex-shrink-0"></i>
            <span class="truncate">Dashboard</span>
        </a>
        <a href="<?= site_url('/katalog') ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition duration-200">
            <i class="bi bi-book flex-shrink-0"></i>
            <span class="truncate">Katalog Buku</span>
        </a>
        <a href="<?= site_url('/peminjamanku') ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition duration-200">
            <i class="bi bi-bookmark flex-shrink-0"></i>
            <span class="truncate">Peminjamanku</span>
        </a>
        <a href="<?= site_url('/reservasi') ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition duration-200">
            <i class="bi bi-calendar-check flex-shrink-0"></i>
            <span class="truncate">Reservasi Saya</span>
        </a>
        <a href="<?= site_url('/riwayat-denda') ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition duration-200">
            <i class="bi bi-exclamation-circle flex-shrink-0"></i>
            <span class="truncate">Riwayat Denda</span>
        </a>
        <a href="<?= site_url('/pengaturan') ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition duration-200">
